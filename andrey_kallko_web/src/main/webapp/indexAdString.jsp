...
<script type="text/javascript">
    ...
    function deleteNode () {
        ...
        //matrix[numero][0]=0;
        //matrix[numero][1]=0;
        document.body.removeChild(document.getElementById('tfNName'+numero));
        document.body.removeChild(document.getElementById('tfBName'+numero));
        document.body.removeChild(document.getElementById('btn1'+numero));
        document.body.removeChild(document.getElementById('btn2'+numero));
        //document.getElementById('tf'+numero).removeChild();
...
///        document.body.writeln("<br>");
        ...
        btn2.value='delete';
        document.body.appendChild(btn2);
        document.getElementById('btn2'+sizer).onclick = deleteNode;
//
...
<%--{--%>
    ...
    <%--new_input.innerHTML='<input id = "phone" name="telephone">'+'<input name="balance">';--%>
...
<%--{--%>
    <%--document.getElementById('one').removeChild(obj)--%>
<%--}--%>

<%--function edit_input(obj){--%>

    <%--var proba = document.getElementById('phone').value;--%>
    <%--alert("Matrix" + proba);--%>
