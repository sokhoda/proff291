    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException {
        ...
        if (req.getParameter("updNtb") != null) {
            try {
                ...
                Integer totPages = hw7.notes.view.Menu.service.getNotebookTypesTotPages(sPortion);
                List notebookPortion = hw7.notes.view.Menu.service
        ...
        if (req.getParameter("listNtbByPortion") != null || req.getParameter("listNtbStore") != null) {
            try {
                ...
                Integer totPages = hw7.notes.view.Menu.service.getNotebookInStoreTotPages(sPortion);

                List noteInStorePortion = hw7.notes.view.Menu.service.getNotebooksByPortion(sPortion, 1);
                req.setAttribute("cnt", 1);
                req.setAttribute("totPages", totPages);
