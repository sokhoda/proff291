package controller.session14.domain;
...
//    @JoinColumn(name = "JOB_ID")
    ...
    private web.domain.Employee manager;
...
//        @JoinColumn(name = "DEPARTMENT_ID")
    ...
    public web.domain.Employee getManager() {
        return manager;
    }

    public void setManager(web.domain.Employee manager) {
