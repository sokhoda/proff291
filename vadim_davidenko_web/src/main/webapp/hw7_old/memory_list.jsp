...
<form name="regForm" action="/memoryListServlet" method="post">

    <table align="center" cellpadding="3" style="background-color: #d4ecff">

        <tr><td align="center" colspan="3"><h3>Memory list</h3></td></tr>
        ...
        <tr><td colspan="3">
            <table border="1" cellpadding="3">
                <tr style="background-color: #d4ecff">
                    ...
                    <th align="center" width="170px">Size</th>
                </tr>
                <%
                ...
                %>
                <tr>
                    <td><input type="radio" name="item" value="<%=String.valueOf(memory.getId())%>"></td>
                    <td align="center"><%= String.valueOf(memory.getId()) %></td>
                    <td align="center"><%= memory.getVendor() %></td>
                    <td align="center"><%= String.valueOf(memory.getSize()) %></td>
                </tr>
                <% } } %>
            </table>
        </td></tr>
