...
//!!!!
    ...
    @RequestMapping(value = "/emp.html", method = RequestMethod.GET)
    public @ResponseBody String emp(@RequestParam("login") String name) {
        log.info("/emp.html controller");
        return service.getEmployeeByFirstName(name).toString();
    }
