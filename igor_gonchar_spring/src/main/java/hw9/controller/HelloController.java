...
//        return Arrays.asList(new Employee("Pasha"), new Employee("Masha"));
    ...
    @RequestMapping(value = "/findUser.html", method = RequestMethod.GET)
    public  @ResponseBody String findUserByName(@RequestParam("login") String name) {
        log.info("/findUser.html controller");
        return service.findUserByName(name).toString();
    }
...
//        employeeService.findAll();
    ...
    @RequestMapping(value = "/repeatNameController", method = RequestMethod.GET)
